...
$username = "voicee";//baza nomi
$password = "parilzJ6mU0cZ6nbW3g";//baza paroli
...
$admin = "1633711494";
$kanal="@osiyo_xakeer";
$bot="osiyo_xakeer_skachat_bot";
$kanal1="ANDROID_DASTURLAR_Playmarket_HD";
$kanal2="janonima_jononim";
...
$reklama="🔧Bot yaratish xizmati: @BotirRaimqulovUz 📬";
$mid = $message->message_id;
mkdir(step);
...
'inline_keyboard'=>[
[["text"=>"📢Obuna bo‘lish","url"=>"https://t.me/$kanal1"],],
[["text"=>"📢Obuna bo‘lish","url"=>"https://t.me/$kanal2"],],
