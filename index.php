...
//@php_kodlar_akramjonov kanali tarjima qildi
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        ...
        [
          ['text'=>'Kanal','url'=>'https://telegram.me/uzxgroup']
        ],
        [
          ['text'=>'Creator','url'=>'https://telegram.me/akramjonov_begzodbek']
        ]
      ]
    ])
  ]);
    bot('SendPhoto',[
'chat_id'=>$chat_id,
'photo'=>"https://t.me/uzb_php_bot/135",
'caption'=>"Fileni edit qilish uchun rasmni koring", 'reply_markup'=>json_encode([
      'inline_keyboard'=>[

       
[
          ['text'=>'Admin','url'=>'https://telegram.me/akramjonov_begzodbek']
        ]
      ]
    ])
]);
